<div>
    ...
    <div wire:ignore class="modal fade" id="winnerModal"  data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                ...
                <div class="modal-body">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-auto">
                            ...
                            @if($rand == 'a')
                                <iframe src="https://giphy.com/embed/26u4exk4zsAqPcq08" width="480" height="270" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><p><a href="https://giphy.com/gifs/awkwafina-26u4exk4zsAqPcq08"></a></p>
                           @elseif($rand == 'b')
                                <iframe src="https://giphy.com/embed/3o7bu57lYhUEFiYDSM" width="480" height="310" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><p><a href="https://giphy.com/gifs/alroker-al-roker-3o7bu57lYhUEFiYDSM"></a></p>
                            @elseif($rand == 'c')
                                <iframe src="https://giphy.com/embed/sVnKj2wDhUTsFKFWhx" width="480" height="400" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><p><a href="https://giphy.com/gifs/theoffice-sVnKj2wDhUTsFKFWhx"></a></p>
                            @endif
                        </div>
                    </div>
                </div>
